...
const SignUp = () => {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className='space-y-4 max-w-md mx-auto shadow-2xl px-6 py-8 rounded-md'>
        ...
        />
        <Button className='cursor-pointer' type='Submit' onClick={handleClick}>Sign Up</Button>
